        ...
        <div class="col-12">
            <div class="mb-3">
                <div class="form-check form-check-inline">
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" {{ $data->category == 'On Proses' ? 'checked' : null }} type="radio" name="category" id="category-danger" value="danger">
                    <label class="form-check-label" for="category-danger">On Proses</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" {{ $data->category == 'Wedding Day' ? 'checked' : null }} type="radio" name="category" id="category-warning" value="warning">
                    <label class="form-check-label" for="category-warning">Wedding Day</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" {{ $data->category == 'Done' ? 'checked' : null }} type="radio" name="category" id="category-info" value="info">
                    <label class="form-check-label" for="category-info">Done</label>
                  </div>
            </div>
        </div>
        <div class="col-12">
