...
<head>
    ...
    <title>Admin Dashboard | Makna Wedding Organizer - @yield('title')</title>
    <!-- Favicon icon -->
        ...
        <div class="deznav">
            <div class="deznav-scroll mm-active">
				<ul class="metismenu mm-show" id="menu">
                    ...
                    <li class="{{ request()->routeIs('events.index') ? 'mm-active' : '' }}">
                        <a class="ai-icon" href="{{ route('events.index') }}" aria-expanded="false">
