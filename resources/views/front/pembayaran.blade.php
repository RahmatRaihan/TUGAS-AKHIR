            ...
            $("#bayarPaketForm").validate({
                rules: {
                    ...
                    tanggal_acara: {
                        required: true,
                        remote: {
                    url: " {{route ('cek-data-date') }}", // Ubah URL sesuai dengan endpoint yang sesuai di aplikasi Anda
                    type: "POST",
                    data: {
                        tanggal_acara: function() {
                            return $("#bayarPaketForm").val(); // Ganti dengan ID input tanggal yang sesuai
                        }
                    }
                }
                    },
                ...
                messages: {
                    ...
                    tanggal_acara: {
                        ...
                        remote: "Tanggal ini sudah terpakai. Silakan pilih tanggal lain."
                    }
                },
