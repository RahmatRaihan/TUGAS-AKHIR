        ...
        <div class="container d-xl-flex align-items-start">
            <div class="hero_about col-xl-6">
                <div class="hero_header">
                    <h2 class="hero_header-title" style="color: #765827;">Mari Rencanakan Pernikahan Yang Sempurna Bersama
                        Makna Wedding Organizer</h2>
            ...
            <div class="hero_promo col-xl-6">
                <div>
                    <picture>
                        <source data-srcset="{{ asset('home4.jpg') }}"
                            srcset="{{ asset('home4.jpg') }}" type="image/webp" />
                        <img class="lazy" style="border-radius:7px;" data-src="{{ asset('home4.jpg') }}"
                            src="{{ asset('home4.jpg') }}" alt="media" />
                    </picture>
                </div>
            </div>
        </div>
    ...
    <section class="featured section--nopb">
        <div class="container">
            <div class="featured_header">
                <h2 class="featured_header-title" style="color: #765827;">Paket Pilihan</h2>
    ...
    <section class="instagram" style="margin-top: 100px;">
        <div class="container">
            <div class="instagram_header">
                <h2 class="instagram_header-title" style="color: #765827;">Ikuti Kita di Instagram</h2>
        ...
        <div class="instagram_slider swiper">
            <div class="swiper-wrapper">
                ...
                <div class="instagram_slider-slide swiper-slide">
                    <a class="link" href="https://instagram.com" target="_blank" rel="noopener norefferer">
                        <picture>
                            <source data-srcset="{{ asset('footer-3.jpeg') }}" srcset="{{ asset('footer-3.jpeg') }}"
                                type="image/webp" />
                            <img class="lazy" data-src="{{ asset('footer-3.jpeg') }}"
                                src="{{ asset('footer-3.jpeg') }}" style="object-fit: cover;height: 400px;"
                                alt="instagram post" />
                        </picture>
                        <span class="overlay d-flex justify-content-center align-items-center">
                            <i class="icon-instagram"></i>
