...
<head>
    ...
    <title>Makna Wedding Organizer Organizer | Profesional Wedding Organizer at Pontianak, Kalimantan Barat - Indonesia</title>
...
<body>
            ...
            <nav class="header_nav">
                <ul class="header_nav-list">
                    <li class="header_nav-list_item">
                        <a class="nav-link d-inline-flex align-items-center" style="color: #765827;"
                            href="{{ url('/') }}">
                            Beranda
                        </a>
                    </li>
                    ...
                    <ul class="footer_main-contacts_list">
                        ...
                        <li class="list-item d-flex align-items-center">
                            <span class="icon d-flex justify-content-center align-items-center">
                                <i class="icon-location" style="color: #765827"></i>
                            </span>
                        ...
                        <li class="list-item d-flex align-items-center">
                            <span class="icon d-flex justify-content-center align-items-center">
                                <i class="icon-clock" style="color: #765827"></i>
                            </span>
                            <div class="wrapper d-flex flex-column">
                        ...
                        <li class="list-item d-flex align-items-center">
                            <span class="icon d-flex justify-content-center align-items-center">
                                <i class="icon-call" style="color: #765827"></i>
                            </span>
                            <div class="wrapper d-flex flex-column">
                                @foreach ($web as $data)
                                    <a class="link"
                ...
                <div class="footer_main-instagram footer_main-block col-md-6 col-xl-auto">
                    ...
                    <ul class="footer_main-instagram_list d-grid">
                        ...
                        <li class="list-item">
                            <a class="link" href="#" rel="noopener norefferer">
                                <picture>
                                    <source data-srcset="{{ asset('footer-3.jpeg') }}"
                                        srcset="{{ asset('footer-3.jpeg') }}" type="image/webp" />
                                    <img class="lazy preview" data-src="{{ asset('footer-3.jpeg') }}"
                                        src="{{ asset('footer-3.jpeg') }}" alt="instagram post" />
                                </picture>
                            </a>
                        </li>
                        <li class="list-item">
                                    ...
                                    <div
                                        ...
                                        <div class="qty d-flex align-items-center justify-content-between">
                                            <span class="d-flex align-items-center"
                                                ...
                                                <i class="icon-minus" style="color: #765827"></i>
                                            </span>
                                            ...
                                            <span class="d-flex align-items-center"
                                                ...
                                                <i class="icon-plus" style="color: #765827"></i>
                                            </span>
                                        </div>
    ...
    <div class="cartOffcanvas offcanvas offcanvas-end" tabindex="-1" id="loginCartCanvas">
        <div class="cartOffcanvas_header d-flex align-items-center justify-content-between">
            <h2 class="cartOffcanvas_header-title" id="cartOffcanvasLabel" style="color: #765827;">Login untuk
    ...
    <div class="cartOffcanvas offcanvas offcanvas-end" tabindex="-1" id="loginCanvas">
        <div class="cartOffcanvas_header d-flex align-items-center justify-content-between">
            <h2 class="cartOffcanvas_header-title" id="cartOffcanvasLabel" style="color: #765827;">Login</h2>
            <button class="cartOffcanvas_header-close" type="button" data-bs-dismiss="offcanvas"
                aria-label="Close">
                <i class="icon-close"></i>
            </button>
        ...
        <div class="cartOffcanvas_body">
            ...
            <p style="margin-top: 20px !important;">Belum punya akun ? <a data-bs-toggle="offcanvas"
                    data-bs-target="#registrasiCanvas" style="color:#765827;">Registrasi</a></p>
        </div>
    </div>

    <div class="cartOffcanvas offcanvas offcanvas-end" tabindex="-1" id="registrasiCanvas">
        <div class="cartOffcanvas_header d-flex align-items-center justify-content-between">
            <h2 class="cartOffcanvas_header-title" id="cartOffcanvasLabel" style="color:#765827;">Registrasi</h2>
            <button class="cartOffcanvas_header-close" type="button" data-bs-dismiss="offcanvas"
                aria-label="Close">
                <i class="icon-close"></i>
            </button>
