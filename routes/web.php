...
use App\Http\Controllers\Back\DateCheckController;
...
use App\Http\Controllers\Front\calenderController;
...
Route::get('/clientrev', [HomeController::class, 'clientrev'])->name('home.clientrev');
...
Route::get('events/list', [calenderController::class, 'listEvent'])->name('events.list');
Route::resource('events2', calenderController::class);
...
Route::group(['middleware' => ['admin']], function () {
    Route::prefix('admin')->group(function () {
        ...
        // 'listEvent'])->name('events.list');
        // Route::resource('events', EventController::class);    
    });

    //DateCheckController
    Route::post('/check-duplicate-date', [DateCheckController::class, 'checkDuplicateDate'])->name('cek-data-date');
});
